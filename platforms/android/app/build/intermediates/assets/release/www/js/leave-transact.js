			...
			success: function(msg) { 
				...
				$("#balance_vl").html(leave_balance["VL"]);
                                ...
                                if (leave_status["0"]["remarks"] != null) {
                                    depRemarks = leave_status["0"]["remarks"] + "<br/>";
                                }
                                if (leave_status["1"]["remarks"] != null) {
                                    hrRemarks = leave_status["1"]["remarks"] + "<br/>";
                                }
                                
                                
				$("#remark_dept").html(depRemarks + '<i class="far fa-user"></i>&nbsp;' + leave_status["0"]["approver_name"]);
				$("#remark_dept_date").html('<i class="far fa-clock"></i>&nbsp;' +  leave_status["0"]["rec_ins_dt"]);
				
				$("#remark_hr").html(hrRemarks + '<i class="far fa-user"></i>&nbsp;' + leave_status["1"]["approver_name"]);
